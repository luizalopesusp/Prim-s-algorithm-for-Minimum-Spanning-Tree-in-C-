# EP1 — Minimum Spanning Tree with Prim's Algorithm 🌐

![Language](https://img.shields.io/badge/language-C-blue?style=flat-square&logo=c)
![Algorithm](https://img.shields.io/badge/algorithm-Prim's%20Algorithm-orange?style=flat-square)
![Data Structure](https://img.shields.io/badge/data%20structure-Min--Heap%20%7C%20Graph-purple?style=flat-square)
